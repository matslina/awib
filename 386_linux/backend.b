...
# Add size of OPEN machine code (= 7) to top stack element and then add a new
# stack element holding size of CLOSE machine code (= 7)
>>[>>]>>>[[[>]>]>]<<<->>+++++++[-<<<<
{ 16b inc >>>++++++++[-<++++++++>]<[->++++<]<[->+>-<<]>+
                         [-<+>]+>-[<->[-]]<[-<[-]<+>>]<< }
>>>>]<+++++++>+>>->->[>]>>
...
<[-
# CLOSE: 3A39660F85XXYY  where XXYY = 16 bit jmp offset
...
<[-
# OPEN: 3A39660F84XXYY  where XXYY = 16 bit jmp offset
% ::: 0 *0 0 0 (bcode) 0 1 ::: 1 0 0 0 1 XX YY (jmplist)
+++++++[->++++++++<]>++.-.------[->++<]>.
<+++[-<+++++>]<.[->>++<<]>>.[-]>
[>>]>[>]+>+>+>->>.[-]<.[-]<<[<]<<[<<]<
